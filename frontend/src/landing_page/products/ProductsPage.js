...
function ProductsPage() {
    return ( 
        ...
        <RightSection imageURL="media/images/kiteconnect.png" productName="Kite Connect API" productDescription="Build powerful trading platforms and experiences with our super simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase."  learnMore="Kite Connect"/>
...
<h5 style={{textAlign:"center"}}>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>Zerodha.tech </a>blog.</h5>

<Universe  productName="The Zerodha Universe" productDescription="Extend your trading and investment experience even further with our partner platforms" />
        </>
     );
}
